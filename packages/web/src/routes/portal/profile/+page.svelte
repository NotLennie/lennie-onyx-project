...
<PageShell bgImage="/images/portal_background.png">
  <PageHeader eyebrow="Client Portal" title="PROFILE" user={data.user} />
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
    ...
    <Card label="Personal Details">
      ...
      <div style="margin-bottom:10px;"><label class="field-label" for="phone">Phone</label><input id="phone" type="tel" bind:value={phone} class="field-input" autocomplete="tel" /></div>
      <div style="margin-bottom:16px;"><label class="field-label" for="address">Address</label><input id="address" type="text" bind:value={address} class="field-input" autocomplete="street-address" /></div>
